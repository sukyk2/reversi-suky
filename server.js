...
/* Set up a registry of player information and their sockt ids */
let players = [];
  ...
  /* expected payload:
      {
        ...
        'username': the name of the user joining the join_room
      }
  */
  /* join_room_response:
    {
      ...
      'count': the number of users in the chatroom
  ...
  socket.on('join_room', (payload) => {
    ...
    io.in(room).fetchSockets().then((sockets)=>{
      ...
      /* Announce to everyone that is in the room, who else is the room */
      ...
      /* Tell everyone that a new user has joined the charoom */
